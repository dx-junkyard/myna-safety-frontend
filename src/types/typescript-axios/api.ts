  ...
  return {
    ...
    callbackCallbackPost: async (
      ...
      if (xLineSignature != null) {
        localVarHeaderParameter['x-line-signature'] =
          typeof xLineSignature === 'string' ? xLineSignature : JSON.stringify(xLineSignature)
      }
...
export const LineBotApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async callbackCallbackPost(
      xLineSignature?: any,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.callbackCallbackPost(
        xLineSignature,
        options
      )
 ...
 * @export
 */
export const LineBotApiFactory = function (
  ...
  return {
    ...
    callbackCallbackPost(xLineSignature?: any, options?: any): AxiosPromise<any> {
      return localVarFp
        .callbackCallbackPost(xLineSignature, options)
...
export class LineBotApi extends BaseAPI {
  ...
  public callbackCallbackPost(xLineSignature?: any, options?: AxiosRequestConfig) {
    return LineBotApiFp(this.configuration)
      .callbackCallbackPost(xLineSignature, options)
...
export const ReportApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    postUserReportFeedbackCommentReportReportIdFeedbackCommentPost: async (
      reportId: string,
      entryUserReportFeedBackCommentRequest: EntryUserReportFeedBackCommentRequest,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'reportId' is not null or undefined
      assertParamExists(
        'postUserReportFeedbackCommentReportReportIdFeedbackCommentPost',
        'reportId',
        reportId
      )
      ...
      const localVarPath = `/report/{report_id}/feedback_comment`.replace(
        `{${'report_id'}}`,
     ...
     * @throws {RequiredError}
     */
    postUserReportFeedbackReactionReportReportIdFeedbackReactionPost: async (
      reportId: string,
      entryUserReportFeedBackReactionRequest: EntryUserReportFeedBackReactionRequest,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'reportId' is not null or undefined
      assertParamExists(
        'postUserReportFeedbackReactionReportReportIdFeedbackReactionPost',
        'reportId',
        reportId
      )
      ...
      const localVarPath = `/report/{report_id}/feedback_reaction`.replace(
        `{${'report_id'}}`,
        encodeURIComponent(String(reportId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    postUserReportReportPost: async (
     ...
     * @throws {RequiredError}
     */
    putUserReportReportUserReportIdPut: async (
      userReportId: string,
      request: UpdateUserReportRequest,
      file?: File,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/report/{user_report_id}`.replace(
        `{${'user_report_id'}}`,
        encodeURIComponent(String(userReportId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
...
export const ReportApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getUserReportsReportGet(
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListUserReportResponse>> {
     ...
     * @throws {RequiredError}
     */
    async postUserReportFeedbackCommentReportReportIdFeedbackCommentPost(
      reportId: string,
      entryUserReportFeedBackCommentRequest: EntryUserReportFeedBackCommentRequest,
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<EntryUserReportFeedBackCommentResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postUserReportFeedbackCommentReportReportIdFeedbackCommentPost(
          reportId,
          entryUserReportFeedBackCommentRequest,
          options
        )
     ...
     * @throws {RequiredError}
     */
    async postUserReportFeedbackReactionReportReportIdFeedbackReactionPost(
      reportId: string,
      entryUserReportFeedBackReactionRequest: EntryUserReportFeedBackReactionRequest,
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<EntryUserReportFeedBackReactionResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postUserReportFeedbackReactionReportReportIdFeedbackReactionPost(
          reportId,
          entryUserReportFeedBackReactionRequest,
          options
        )
     ...
     * @throws {RequiredError}
     */
    async postUserReportReportPost(
      request: EntryUserReportRequest,
      file?: File,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<EntryUserReportResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postUserReportReportPost(
        request,
        file,
        options
      )
     ...
     * @throws {RequiredError}
     */
    async putUserReportReportUserReportIdPut(
      userReportId: string,
      request: UpdateUserReportRequest,
      file?: File,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateUserReportResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.putUserReportReportUserReportIdPut(
        userReportId,
        request,
        file,
        options
...
export const ReportApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    postUserReportReportPost(
      request: EntryUserReportRequest,
      file?: File,
      options?: any
    ): AxiosPromise<EntryUserReportResponse> {
      return localVarFp
        .postUserReportReportPost(request, file, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * ユースケース3: ユーザがヘルプ情報を更新する
    ...
    putUserReportReportUserReportIdPut(
      ...
      file?: File,
      options?: any
    ): AxiosPromise<UpdateUserReportResponse> {
      return localVarFp
        .putUserReportReportUserReportIdPut(userReportId, request, file, options)
        .then((request) => request(axios, basePath))
    }
  }
}
...
export class ReportApi extends BaseAPI {
  ...
  public getUserReportsReportGet(options?: AxiosRequestConfig) {
    return ReportApiFp(this.configuration)
      .getUserReportsReportGet(options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ReportApi
   */
  public postUserReportFeedbackCommentReportReportIdFeedbackCommentPost(
    reportId: string,
    entryUserReportFeedBackCommentRequest: EntryUserReportFeedBackCommentRequest,
    options?: AxiosRequestConfig
  ) {
   ...
   * @memberof ReportApi
   */
  public postUserReportFeedbackReactionReportReportIdFeedbackReactionPost(
    reportId: string,
    entryUserReportFeedBackReactionRequest: EntryUserReportFeedBackReactionRequest,
    options?: AxiosRequestConfig
  ) {
   ...
   * @memberof ReportApi
   */
  public postUserReportReportPost(
    request: EntryUserReportRequest,
    file?: File,
    options?: AxiosRequestConfig
  ) {
   ...
   * @memberof ReportApi
   */
  public putUserReportReportUserReportIdPut(
    userReportId: string,
    request: UpdateUserReportRequest,
    file?: File,
    options?: AxiosRequestConfig
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    putUserUserLineUserIdPut: async (
      lineUserId: string,
      ...
      const localVarPath = `/user/{line_user_id}`.replace(
        `{${'line_user_id'}}`,
        encodeURIComponent(String(lineUserId))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async putUserUserLineUserIdPut(
      lineUserId: string,
      updateUserRequest: UpdateUserRequest,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateUserResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.putUserUserLineUserIdPut(
        lineUserId,
        updateUserRequest,
        options
      )
...
export const UserApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    putUserUserLineUserIdPut(
      lineUserId: string,
      updateUserRequest: UpdateUserRequest,
      options?: any
    ): AxiosPromise<UpdateUserResponse> {
      return localVarFp
        .putUserUserLineUserIdPut(lineUserId, updateUserRequest, options)
        .then((request) => request(axios, basePath))
    }
  }
}
...
export class UserApi extends BaseAPI {
   ...
   * @memberof UserApi
   */
  public putUserUserLineUserIdPut(
    lineUserId: string,
    updateUserRequest: UpdateUserRequest,
    options?: AxiosRequestConfig
  ) {
